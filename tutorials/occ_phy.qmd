...
**IMPORTANT NOTE**: Only do this if you are using your own computer! **Skip this step if you are running the code in the cloud**, i.e., [in a binder](https://mybinder.readthedocs.io/en/latest/about/user-guidelines.html#how-secure-is-mybinder-org). In that case, enter your credentials directly into the `occ_download()` function.
