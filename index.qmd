...
![](images/georefs.png){fig-alt="Comparison of different types of georeference systems" height="400"}
...
2. Clean occurrence records (`CoordinateCleaner`, `bdc`)
3. Standardize species names (`taxonDB`, `bdc`)
...
::: {.column width="40%"}
![](https://joelnitta.github.io/botany2020/images/ja_example_ferns.png){fig-alt="alt-text" height="650"}
:::
...
::: {.column width="60%"}
![](https://joelnitta.github.io/botany2020/images/japan_intro.png){fig-alt="alt-text" height="650"}
:::
...
Need to compare amount of observed autocorrelation to some expected value: **Moran's I**

![](https://static.cambridge.org/binary/version/id/urn:cambridge.org:id:binary:20200421144010724-0711:9781108614528:49898fig4_1.png?pub-status=live){fig-alt="Image of different values of Moran's I" height="450"}
...
Understanding distribution of bio-regions
...
![](images/japan_region.png){fig-alt="Figure showing bioregions of ferns of Japan" height="500"}
...
1. Load phylogeny and community data
